...
setInterval(()=>{
    ...
    const secondsOnesAngle = 36 * (String(seconds).length === 1 ? String(seconds)[0]:String(seconds)[1]);
    const secondsTensAngle = 36 * (String(seconds).length === 1 ? 0:String(seconds)[0]);
    const minuteOnesAngle = 36 * (String(minutes).length === 1 ? String(minutes)[0]:String(minutes)[1]);
    const minuteTensAngle = 36 * (String(minutes).length === 1 ? 0:String(minutes)[0]);
    const hourOnesAngle = 36 * (String(hours).length === 1 ? String(hours)[0]:String(hours)[1]);
    const hourTensAngel = 36 * (String(hours).length === 1 ? 0:String(hours)[0]);
